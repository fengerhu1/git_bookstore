...
class Personaldata extends Component {
    ...
    constructor(props) {
        ...
        name1:"小老虎",name2:"fengerhu1@126.com",name3:"**********",name4:"18217313571",name5:"上海市闵行区上海交通大学学生宿舍西11",};
                                ...
                                <table className="table table-hover" style={ep1}>
                                    <tbody>
                                        <tr style={ep}>
                                            ...
                                            <td style={ep}>
                                                <div style={bp1} onClick={this.click1}>{this.state.name1}</div>
                                                <div style={bp2}>
                                        ...
                                        <tr style={ep}>
                                            ...
                                            <td style={ep}>
                                                ...
                                                <div style={bp4}>
                                                    <input className="col-md-5 " value={this.state.name2} placeholder={this.state.name2} style={gp}/>
                                        ...
                                        <tr style={ep}>
                                            ...
                                            <td style={ep}>
                                                ...
                                                <div style={bp6}>
                                                    <input className="col-md-5 " value={this.state.name3} placeholder={this.state.name3} style={gp}/>
                                        ...
                                        <tr style={ep}>
                                            ...
                                            <td style={ep}>
                                                ...
                                                <div style={bp8}>
                                                    <input className="col-md-5 " value={this.state.name4} placeholder={this.state.name4} style={gp}/>
                                        ...
                                        <tr style={ep}>
                                            ...
                                            <td style={ep}>
                                                ...
                                                <div style={bp10}>
                                                    <input className="col-md-5 "value={this.state.name5} placeholder={this.state.name5} style={gp}/>
