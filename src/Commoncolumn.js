...
class Commoncolumn extends Component {
    constructor(props) {
        super(props);
        this.state = {cn1:false,cn2:false,cn3:false,cn4:false,cn5:true};
                        ...
                        <i className="fa fa-bars"></i>
                            ...
                            <div className="collapse navbar-collapse" id="main-menu">
                                <ul className="menu">
                                    ...
                                    <li  className={cn3} role="presentation"onClick={this.click3}style={{position:"relative" ,right:"-170px"}}><a>我的订单</a></li>
                                    ...
                                    <li className={cn5} role="presentation" style={{position:"relative" ,right:"-250px"}}><Link to="./personaldata">小老虎，欢迎你</Link></li>
